...
tellraw @a[predicate=bosses:in_dim] [{"text":"[NO]","color":"dark_red","bold":true,"italic":false,"clickEvent":{"action":"run_command","value":"/trigger arenaCancel"}},{"text":"   "},{"text":"[YES]","color":"green","bold":true,"italic":false,"clickEvent":{"action":"run_command","value":"/trigger piglisanSpawn"}}]
tellraw @a[predicate=bosses:in_dim] {"text":""}
tellraw @a[predicate=bosses:in_dim] {"text":"-------------------------------------","color":"blue","bold":false,"italic":false}
